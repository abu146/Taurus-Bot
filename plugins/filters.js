...
const array = ['Pikachu','Msd','Vijay','Rashmika','song','Sry','Line','Aarulle','bot','Aktfa','Hello','Xxxtentacion','achodaa','ayin','Aysheri','Ayye','Ayyo','broken','bye','chattho','cute','Da','Eee','engane und','Entha','Enthada','Girls','Good morning','Good night','Hi','Hy','ithokke ','Muthe','Police','Abu','😬','Chaya','Redshot','custom','enthda','frk','happynanba','vegam','room','vibesad','Sed']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
